    ...
    def start(self):
        ...
        while True:
            ...
            for film, poster_img in films:
                ...
                # cv.drawMatches(poster_img, keypoints_obj, frame, keypoints_scene,
                ...
                """
                cv.line(frame, (int(scene_corners[0,0,0] + poster_img.shape[1]), int(scene_corners[0,0,1])),\
                    (int(scene_corners[1,0,0] + poster_img.shape[1]), int(scene_corners[1,0,1])), (0,255,0), 4)
                cv.line(frame, (int(scene_corners[1,0,0] + poster_img.shape[1]), int(scene_corners[1,0,1])),\
                    (int(scene_corners[2,0,0] + poster_img.shape[1]), int(scene_corners[2,0,1])), (0,255,0), 4)
                cv.line(frame, (int(scene_corners[2,0,0] + poster_img.shape[1]), int(scene_corners[2,0,1])),\
                    (int(scene_corners[3,0,0] + poster_img.shape[1]), int(scene_corners[3,0,1])), (0,255,0), 4)
                cv.line(frame, (int(scene_corners[3,0,0] + poster_img.shape[1]), int(scene_corners[3,0,1])),\
                    (int(scene_corners[0,0,0] + poster_img.shape[1]), int(scene_corners[0,0,1])), (0,255,0), 4)
